    ...
    def do_for_fitness_fn(
        ...
        if ref_laplacian is None:
            ...
            if ref_contact_map is None:
                ...
                ref_contact_map = compute_contacts_map(ref_atoms, 
        ...
        predicted_laplacian = context.get_extra_param_value("esm2_predicted_norm_laplacian")
        if predicted_laplacian is None:
            ...
            predicted_contacts = \
                self.esm_model.contacts_map_from_prediction(predicted_contacts, self.min_separation)
            predicted_laplacian = self.normalized_laplacian(predicted_contacts)
            context.set_extra_param_value("esm2_predicted_norm_laplacian", predicted_laplacian)
