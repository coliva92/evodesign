...
class DisulfideCyclization(StructuralMetric):
    ...
    _dihedral_scaling_factors = {"SG-SG": 100.0, "CA-CB": 100.0}
    ...
    def evaluate_ss_dihedral(
        ...
        return (
            np.rad2deg(x),
            Norm.reciprocal(
                abs(tmp_norm - 1.0), self._dihedral_scaling_factors["SG-SG"]
            ),
        )
    ...
    def evaluate_ca_cb_dihedral(
        ...
        return (
            np.rad2deg(x),
            Norm.reciprocal(
                abs(tmp_norm - 1.0), self._dihedral_scaling_factors["CA-CB"]
            ),
        )
