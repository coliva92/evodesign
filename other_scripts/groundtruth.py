...
reference = Chain.load_structure_from_pdb(args.refPdbFilename)
reference = Chain.filter_backbone_atoms_in_chain(reference)
model = Chain.load_structure_from_pdb(args.modelPdbFilename)
model = Chain.filter_backbone_atoms_in_chain(model)
